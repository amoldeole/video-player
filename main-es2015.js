...
AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: AppComponent, selectors: [["app-root"]], decls: 3, vars: 0, consts: [["id", "player", "playsinline", "", "controls", "", "data-poster", "/path/to/poster.jpg"], ["src", "../assets/4_AveMgrhPqslbktD.webm", "type", "video/mp4"], ["src", "../assets/4_AveMgrhPqslbktD.webm", "type", "video/webm"]], template: function AppComponent_Template(rf, ctx) { if (rf & 1) {
...
module.exports = __webpack_require__(/*! D:\weatherInformation\weather-info\src\main.ts */"./src/main.ts");
